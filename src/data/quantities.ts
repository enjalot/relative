...
export const quantities: QuantityEntry[] = [
  ...
  // ============================================================
  {
    ...
    value: 25,
    unitId: 'cent',
    description: 'A gumball from a vending machine costs about $0.25.',
    category: 'currency',
  },
  {
    id: 'cup-of-coffee',
    ...
    value: 5,
    unitId: 'USD',
    description: 'A medium coffee at a café costs about $4–6. Using $5.',
    category: 'currency',
  },
  {
    id: 'fast-food-meal',
    ...
    value: 10,
    unitId: 'USD',
    description: 'A typical fast food combo meal costs about $8–12. Using $10.',
    category: 'currency',
  },
  {
    id: 'movie-ticket',
    ...
    value: 15,
    unitId: 'USD',
    description: 'A movie ticket costs about $12–18 in the US. Using $15.',
    category: 'currency',
  },
  {
    id: 'tank-of-gas',
    ...
    value: 55,
    unitId: 'USD',
    description: 'Filling a 15-gallon tank at ~$3.60/gal costs about $55.',
    category: 'currency',
  },
  {
    id: 'pair-of-shoes',
    ...
    value: 100,
    unitId: 'USD',
    description: 'A mid-range pair of sneakers costs about $80–120. Using $100.',
    category: 'currency',
  },
  {
    id: 'monthly-groceries',
    name: 'Monthly groceries (1 person)',
    emoji: '🛒',
    value: 400,
    unitId: 'USD',
    description: 'Average monthly grocery spending for one person in the US is about $300–500. Using $400.',
    category: 'currency',
  },
  {
    id: 'monthly-rent',
    ...
    value: 1800,
    unitId: 'USD',
    description: 'Average US monthly rent is about $1,500–2,100 (2024). Using $1,800.',
    category: 'currency',
  },
  {
    id: 'used-car',
    ...
    value: 25,
    unitId: 'kUSD',
    description: 'Average used car price in the US is about $25,000–30,000. Using $25,000.',
    category: 'currency',
  },
  {
    id: 'new-car',
    ...
    value: 48,
    unitId: 'kUSD',
    description: 'Average new car price in the US is about $48,000 (2024).',
    category: 'currency',
  },
  {
    id: 'us-median-income',
    ...
    value: 75,
    unitId: 'kUSD',
    description: 'US median household income is about $75,000/year (2023 Census data).',
    category: 'currency',
  },
  {
    id: 'us-median-home',
    ...
    value: 420,
    unitId: 'kUSD',
    description: 'US median existing home sale price is about $420,000 (2024 NAR data).',
    category: 'currency',
  },
  {
    id: 'billion-dollars',
    ...
    value: 1,
    unitId: 'BUSD',
    description: 'One billion US dollars.',
    category: 'currency',
  },
