...
export const quantities: QuantityEntry[] = [
  ...
  {
    id: 'dryer-cycle',
    name: 'Clothes dryer cycle',
    emoji: '👖',
    value: 5,
    unitId: 'kWh',
    description: 'An electric clothes dryer cycle takes about 4–6 kWh. Using 5 kWh.',
    category: 'energy-events',
  },
  {
    id: 'household-daily',
  ...
  {
    id: 'ac-running-all-day',
    name: 'Central AC running all day',
    emoji: '❄️',
    value: 42,
    unitId: 'kWh',
    description: 'A central AC unit (3.5 kW) running 12 hours on a hot day uses about 42 kWh.',
    category: 'energy-events',
  },
  {
    id: 'ev-charger-session',
    name: 'EV full charge (Level 2)',
    emoji: '🔌',
    value: 60,
    unitId: 'kWh',
    description: 'Fully charging a Tesla Model 3 (60 kWh battery) from a Level 2 charger at 7.2 kW takes about 8–9 hours.',
    category: 'energy-events',
  },
  ...
  {
    id: 'school-daily',
    name: 'School building daily use',
    emoji: '🏫',
    value: 2.4,
    unitId: 'MWh',
    description: 'A typical K-12 school (100 kW average) uses about 2,400 kWh per day.',
    category: 'energy-large',
  },
  {
    id: 'hospital-daily',
    name: 'Hospital daily use',
    emoji: '🏥',
    value: 48,
    unitId: 'MWh',
    description: 'A medium hospital (2 MW average) uses about 48 MWh per day.',
    category: 'energy-large',
  },
  {
    id: 'data-center-small-daily',
    name: 'Small data center daily use',
    emoji: '🖥️',
    value: 120,
    unitId: 'MWh',
    description: 'A small data center (5 MW) uses about 120 MWh per day.',
    category: 'energy-large',
  },
  {
    id: 'data-center-hyperscale-daily',
    name: 'Hyperscale data center daily use',
    emoji: '🏗️',
    value: 2.4,
    unitId: 'GWh',
    description: 'A hyperscale data center (100 MW) uses about 2.4 GWh per day.',
    category: 'energy-large',
  },
  {
    id: 'nuclear-reactor-daily',
    name: 'Nuclear reactor daily output',
    emoji: '☢️',
    value: 24,
    unitId: 'GWh',
    description: 'A 1 GW nuclear reactor produces about 24 GWh per day of electricity.',
    category: 'energy-large',
  },
